...
//---------------------------------------------------//
#define LOAD_CELL_RATED_VOLT_100KG 0.002f
...
//---------------------------------------------------//
#define LOAD_CELL_RATED_VOLT_120KG 0.002f
#define LOAD_CELL_RATED_GRAM_120KG 120000.0f

//---------------------------------------------------//
// Load cell SC133 20kg
// https://akizukidenshi.com/catalog/g/gP-12034/
//---------------------------------------------------//
#define LOAD_CELL_RATED_VOLT_20KG 0.002f
#define LOAD_CELL_RATED_GRAM_20KG 20000.0f

//---------------------------------------------------//
// Load cell SC133 2kg
// https://akizukidenshi.com/catalog/g/gP-13041/
//---------------------------------------------------//
#define LOAD_CELL_RATED_VOLT_2KG 0.001f
#define LOAD_CELL_RATED_GRAM_2KG 2000.0f

//---------------------------------------------------//
// Load cell SC616C 500g
// https://akizukidenshi.com/catalog/g/gP-12532/
//---------------------------------------------------//
#define LOAD_CELL_RATED_VOLT_500G 0.0008f
#define LOAD_CELL_RATED_GRAM_500G 500.0f
...
HX711_asukiaaa::Parser parser120kg(LOAD_CELL_RATED_VOLT_120KG,
                                   LOAD_CELL_RATED_GRAM_120KG, HX711_R1,
                                   HX711_R2);
HX711_asukiaaa::Parser parser2kg(LOAD_CELL_RATED_VOLT_2KG,
                                 LOAD_CELL_RATED_GRAM_2KG, HX711_R1, HX711_R2);
